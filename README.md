...
data/ Sadrži izvorne CSV datoteke (mars_sample_locations.csv, mars_soil_samples.csv).

src/ Python skripte za obradu podataka, vizualizaciju i generiranje JSON paketa.

assets/ Generirani grafovi i satelitske snimke korištene u vizualizaciji.
...
(assets/misijska_karta_jezero.jpg)
